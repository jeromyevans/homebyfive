...
import com.blueskyminds.framework.TypedManyRelationship;
...
public class IndividualRelationship extends AbstractDomainObject implements TypedManyRelationship<Party, Individual, IndividualRoleMap>, Named {
    ...
    @ManyToOne(cascade = CascadeType.ALL, targetEntity = com.blueskyminds.enterprise.party.Individual.class)
