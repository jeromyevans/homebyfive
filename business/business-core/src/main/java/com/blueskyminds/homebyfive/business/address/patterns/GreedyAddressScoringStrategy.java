 ...
 */
public class GreedyAddressScoringStrategy extends AbstractScoringStrategy implements ScoringStrategy {
...
//        }
    ...
    private int scoreUnitNumber(PhraseToBinAllocationSequence allocationSequence) {
        ...
        result = testSequence(allocationSequence, UnitNumberBin.class, GreedyStreetNameBin.class);
        switch (result) {
        ...
        result = testSequence(allocationSequence, LotNumberBin.class, GreedyStreetNameBin.class);
        switch (result) {
            case FIRST_BEFORE_SECOND:
                thirdScore = GOOD;
                break;
    ...
    private int scoreStreetNumber(PhraseToBinAllocationSequence allocationSequence) {
        ...
        result = testSequence(allocationSequence, StreetNumberBin.class, GreedyStreetNameBin.class);
    ...
    private int scoreStreetName(PhraseToBinAllocationSequence allocationSequence) {
        ...
        // street name before street type
        result = testSequence(allocationSequence, GreedyStreetNameBin.class, StreetTypeBin.class);
        ...
        result = testSequence(allocationSequence, GreedyStreetNameBin.class, GreedySuburbNameBin.class);

        switch (result) {
            case FIRST_BEFORE_SECOND:
                if (allocationSequence.before(GreedyStreetNameBin.class, StreetTypeBin.class)) {
                    secondScore = GOOD;
                } else {
                    secondScore = BAD;
                }
        ...
        PhraseToBinAllocation allocation = allocationSequence.getAllocationTo(GreedyStreetNameBin.class);
        if (allocation != null) {
    ...
    private int scoreStreetType(PhraseToBinAllocationSequence allocationSequence) {
        ...
        // street type before suburb
        result = testSequence(allocationSequence, StreetTypeBin.class, GreedySuburbNameBin.class);
        ...
        result = testSequence(allocationSequence, StreetSectionBin.class, GreedySuburbNameBin.class);
    ...
    private int scoreSuburb(PhraseToBinAllocationSequence allocationSequence) {
        ...
        // suburb before state
        result = testSequence(allocationSequence, GreedySuburbNameBin.class, StateBin.class);
        ...
        result = testSequence(allocationSequence, GreedySuburbNameBin.class, GreedyPostCodeBin.class);
