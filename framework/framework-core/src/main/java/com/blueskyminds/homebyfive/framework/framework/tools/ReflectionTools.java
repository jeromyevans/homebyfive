...
import com.blueskyminds.homebyfive.framework.framework.reflection.PropertyDescriptor;
...
public class ReflectionTools {
     ...
     * For an marge that overwrites existing properties see {@link com.blueskyminds.homebyfive.framework.framework.AbstractDomainObject#updateSimpleProperties}
     *
     * @param other
     */
    @SuppressWarnings({"unchecked"})
