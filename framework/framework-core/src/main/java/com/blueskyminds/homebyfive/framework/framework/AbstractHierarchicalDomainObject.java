...
import com.blueskyminds.homebyfive.framework.framework.hierarchy.Hierarchy;
import com.blueskyminds.homebyfive.framework.framework.hierarchy.AddChildPolicy;
import com.blueskyminds.homebyfive.framework.framework.hierarchy.DefaultAddChildPolicy;
import com.blueskyminds.homebyfive.framework.framework.hierarchy.ManyParentsHierarchy;
...
/**
 *
 * An abstract implementation of a DomainObject that implements the Hierachy interface.
 *
 * Extends this implementation for domain objects that themselves are hierarchical.
 *
 ...
 */
public class AbstractHierarchicalDomainObject<T extends DomainObject> extends AbstractDomainObject implements Hierarchy<T> {
...
// ------------------------------------------------------------------------------------------------------
    ...
    public AbstractHierarchicalDomainObject() {
        init(null);
    }
     ...
     **/
    public AbstractHierarchicalDomainObject(AddChildPolicy addChildPolicy) {
        init(addChildPolicy);
    }
    ...
    protected void setChildren(Set<T> children) {
     ...
     *  2. The AddChildPolicy states that it's okay to add this child to this parent
     *
