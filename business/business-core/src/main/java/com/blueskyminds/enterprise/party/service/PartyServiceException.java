 ...
 */
public class PartyServiceException extends Exception {
     ...
     * @since 1.4
     */
    public PartyServiceException(Throwable cause) {
        super(cause);
    }
    ...
    /**
     * Initialise the PartyServiceException with default attributes
     */
    private void init() {
    }
